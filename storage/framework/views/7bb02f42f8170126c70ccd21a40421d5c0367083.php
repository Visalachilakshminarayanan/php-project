...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(url('css/log.css')); ?>"/>
	</head>
<body> 
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		...
		<form action="<?php echo e(url('login_page')); ?>" method="POST">
	...
	<div class="form-container sign-in-container">
		<form action="<?php echo e(url('check_update')); ?>" id="frmignin">
		<?php echo e(csrf_field()); ?>
...
</html><?php /**PATH C:\Users\Dell\Documents\xampp\htdocs\project3\resources\views//login_page.blade.php ENDPATH**/ ?>